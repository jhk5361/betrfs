...
struct toku_db_key_operations {
    int (*keycmp) (DB *, const DBT *, const DBT *);
    int (*keypfsplit) (DB *, const DBT *, const DBT *, void (*set_key)(const DBT *new_key, void *set_extra), void *extra);
    int (*keyrename) (const DBT *old_prefix, const DBT *new_prefix, const DBT *, void (*set_key)(const DBT *new_key, void *set_extra), void *set_extra);
    void (*keyprint) (const DBT *key, bool is_tracable_print);
    int (*keylift) (const DBT *lpivot, const DBT *rpivot, void (*set_lift)(const DBT *lift, void *set_extra), void *set_extra);
    int (*keyliftkey) (const DBT *key, const DBT *lifted, void (*set_key)(const DBT *new_key, void *set_extra), void *set_extra);
    int (*keyunliftkey) (const DBT *key, const DBT *lifted, void (*set_key)(const DBT *new_key, void *set_extra), void *set_extra);
};
...
#define db_struct_i(x) ((x)->i)
  ...
  int (*del_multi) (DB *, DB_TXN *, DBT *, DBT *, bool, uint32_t);
  int (*fd) (DB *, int *);
  ...
  int (*rename) (DB *, DB_TXN *, DBT *, DBT *, DBT *, DBT *, uint32_t);
