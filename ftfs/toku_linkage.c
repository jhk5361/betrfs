...
/* toku_linkage() contains references to all the kernel symbols
...
/* void feof(void) { BUG(); } */
/* void ferror(void) { BUG(); } */
/* int fflush(void) { BUG(); }*/
/* void fileno(void) { BUG(); } */
/*  void getenv(void) { BUG(); }*/
pid_t getpid(void) { return current->pid; }
//void getrusage(void) { BUG(); }

int toku_dup2(int oldfd, int newfd)
{
	ftfs_error(__func__, "This function is only used in tests.\n"
		   "It does not need to be defined, and shouldn't be used.\n"
		   "Please fix your test so that it does not call dup2.");
...
//void stat64(void) { BUG(); }
//void statvfs64(void) { BUG(); }

/*void strerror(void) { BUG(); } */
/*void strerror_r(void) { BUG(); } */
