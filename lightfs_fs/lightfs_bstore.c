...
int ftfs_bstore_scan_pages(DB *data_db, DBT *meta_dbt, DB_TXN *txn, struct ftio *ftio, struct inode *inode)
{
	...
	//ftfs_error(__func__, "1: ftio->ft_bvidx: %d, ftio->ft_vcnt: %d block_cnt: %d\n", ftio->ft_bvidx, ftio->ft_vcnt, block_cnt);
	block_cnt = block_cnt > ftio->ft_vcnt - ftio->ft_bvidx ? ftio->ft_vcnt - ftio->ft_bvidx : block_cnt; 
	//ftfs_error(__func__, "2: ftio->ft_bvidx: %d, ftio->ft_vcnt: %d block_cnt: %d\n", ftio->ft_bvidx, ftio->ft_vcnt, block_cnt);
